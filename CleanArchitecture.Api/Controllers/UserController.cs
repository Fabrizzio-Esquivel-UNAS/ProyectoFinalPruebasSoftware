...
public sealed class UserController : ApiController
{
    ...
    public async Task<IActionResult> GetAllUsersAsync(
        ...
        [FromQuery] int[]? searchRoles = null,
    ...
    [HttpPost("changePreferencias")]
    [SwaggerOperation("Change the preferencias for the current active user")]
    [SwaggerResponse(200, "Request successful", typeof(ResponseMessage<ChangePreferenciasViewModel>))]
    public async Task<IActionResult> ChangePreferenciasAsync([FromBody] ChangePreferenciasViewModel viewModel)
    {
        await _userService.ChangePreferenciasAsync(viewModel);
        return Response(viewModel);
    }
